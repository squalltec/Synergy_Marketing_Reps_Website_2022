  ...
  var SmartWizard = /*#__PURE__*/function () {
    ...
    _createClass(SmartWizard, [{
      ...
      value: function _setEvents() {
        ...
        this.main.find('.sw-btn-subm').on("click", function (e) {
        
        
        var rate = document.getElementsByClassName('abcsub')[0];
        rate.click();
      ...
      value: function _createToolbar(position) {
        ...
        var btnSubm = this.options.toolbarSettings.showSubmButton !== false ? $('<button></button>').text(this.options.lang.subm).addClass('btn btn-primary sw-btn-subm').attr('type', 'button') : null;
        
        
        toolbar.append(btnPrevious, btnNext, btnSubm); // Add extra toolbar buttons
      ...
      value: function _setButtons(idx) {
        ...
        if (!this.options.cycleSteps) {
          ...
          this.main.find('.sw-btn-subm').addClass("disabled");
         this.main.find('.sw-btn-subm').css("display", "none");
          ...
          switch (this._getStepPosition(idx)) {
            ...
            case 'last':
              this.main.find('.sw-btn-next').addClass("disabled");
               ...
               this.main.find('.sw-btn-subm').removeClass("disabled");
               
                this.main.find('.sw-btn-next').css("display", "none");
               this.main.find('.sw-btn-subm').css("display", "block");
               this.main.find('.sw-btn-prev').css("display", "block");
              break;
